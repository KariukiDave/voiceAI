...
const useCases = [
  {
    id: "customer-support",
    icon: <Headphones className="h-10 w-10 text-vibrantCyan" />,
  ...
  },
  {
    ...
    icon: <Calendar className="h-10 w-10 text-vibrantCyan" />,
  ...
  {
    id: "order-tracking",
    icon: <Package className="h-10 w-10 text-vibrantCyan" />,
  ...
  },
  {
    ...
    icon: <Users className="h-10 w-10 text-vibrantCyan" />,
  ...
  {
    id: "billing-payments",
    icon: <CreditCard className="h-10 w-10 text-vibrantCyan" />,
  ...
  {
    id: "product-faqs",
    icon: <HelpCircle className="h-10 w-10 text-vibrantCyan" />,
    title: "Product FAQs",
    description:
  ...
  {
    id: "local-business",
    icon: <Building className="h-10 w-10 text-vibrantCyan" />,
  ...
  {
    id: "after-hours",
    icon: <Clock className="h-10 w-10 text-vibrantCyan" />,
        ...
        <section className="py-20 md:py-28">
          <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center mb-16">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl font-poppins text-deepBlue">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {useCases.map((useCase) => (
                <Card
                  key={useCase.id}
                  id={useCase.id}
                  className="overflow-hidden transition-all hover:shadow-md border-softGray"
                >
                  <CardHeader className="pb-3">
                    <div className="p-2 w-fit rounded-lg bg-deepBlue/5 mb-3">{useCase.icon}</div>
                    <CardTitle className="text-xl font-poppins text-deepBlue">{useCase.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <CardDescription className="text-base text-gray-600 font-roboto">
                      {useCase.description}
                    </CardDescription>
                  </CardContent>
                  <CardFooter>
                    <Button variant="ghost" className="p-0 h-auto text-vibrantCyan hover:text-vibrantCyan/80">
            ...
            <div className="mt-16 text-center">
              <h2 className="text-2xl font-bold mb-4 font-poppins text-deepBlue">
                Ready to implement AI voice agents for your business?
              </h2>
              <p className="text-gray-600 mb-8 max-w-2xl mx-auto font-roboto">
